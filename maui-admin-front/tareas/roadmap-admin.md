...
> Este roadmap se ejecuta en **paralelo** con el Sprint 0 del cliente PWA. Sin el Admin, el loop de valor no cierra.
...
```
ADMIN-001 (Setup)         → base de todo
       ↓
ADMIN-002 (Lista)         → necesita backend Orders
