...
| **Producción (Sprint 1+)** | Auth provider real (stack en `docs/adr-001-stack-backend.md`) emitiendo JWT con claim `role`; el `RequireAuth` lee el claim — la firma del hook no cambia |
